...
public class HostEkleWindow extends MainWindow implements CustomPanel{
    ...
    public JButton getBekle() {
        if(this.bekle==null){
            ...
            this.bekle.addActionListener(new HostEkleWindowAction(this));
        }
        return bekle;
    }
    ...
    public JButton getBsil() {
        if(this.bsil==null){
            ...
            this.bsil.addActionListener(new HostEkleWindowAction(this));
        }
        return bsil;
    }
    ...
    public JButton getGeri() {
        if(this.geri==null){
            ...
            this.geri.addActionListener(new HostEkleWindowAction(this));
        }
        return geri;
    }
    ...
    public JButton getCikis() {
        if(this.cikis==null){
            ...
            this.cikis.addActionListener(new HostEkleWindowAction(this));
        }
        return cikis;
    }
